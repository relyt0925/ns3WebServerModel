 ...
 */
#ifndef TCP_WEB_SERVER_HELPER_H
#define TCP_WEB_SERVER_HELPER_H
 ...
 * on a set of nodes.
 */
class TcpWebServerHelper
{
public:
  /**
   * Create a TcpWebServerHelper to make it easier to work with PacketSinkApplications
   *
   ...
   *
   */
  TcpWebServerHelper (std::string protocol, Address address);
